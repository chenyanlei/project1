...
class Yuntongxun_com {
	...
	private $Handle; 
	function __construct($ServerIP,$ServerPort,$SoftVersion,$BodyType,$enabeLog)	
	{
		...
		if ($this->enabeLog)
		{
			$this->Handle = fopen(APPPATH.'logs/sms_log.txt', 'a');
		}
	}
    ...
    */
	  function createSubAccount($friendlyName)
	  {
        ...
        $this->showlog("request body = ".$body." ".$this->Batch);
        // 大写的sig参数  
