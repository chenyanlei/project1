...
<div class="col-sm-10 col-sm-push-2" style="margin-top: 50px">
    <div class="col-sm-12" style="margin-top: 50px">
        <label class="col-sm-2 control-label" style="text-align: right" for="travel_introduction">标题</label>
        <div class="col-sm-10">
    ...
    <div class="col-sm-12" style="margin-top: 50px">
        <label class="col-sm-2 control-label" style="text-align: right" for="travel_introduction">推广描述</label>
        <div class="col-sm-10">
    ...
    <div class="col-sm-12" style="margin-top: 50px;margin-bottom: 50px">
        <label class="col-sm-2 control-label" style="text-align: right" for="travel_introduction">推荐产品</label>
        <div class="col-sm-10">
            <div style="float: left"><img width="200" height="150" src="<?php echo $detail['face_img'] ;?>"></div>
            <div style="float: left; margin-left: 20px">
                <div class="title">
                    <a href="/product/product_detail?pid=<?php echo $detail['id'] ;?>&p_type=<?php echo $detail['p_type'] ;?>"><?php echo $detail['title'] ;?></a>
                </div>
                <div class="destination">
                    目的地：<?php echo $detail['continent'].'  '.$detail['country'] ;?>
                </div>
                <div class="validate">
                    有效期：<?php if($detail['calendar_type'] ==0) echo '全年有效'; else echo '' ;?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-12">
        ...
        <a class="btn btn-primary" onclick="click_upload()">确定</a>
    </div>
...
<script>
    ...
    var m_face_img = '';
    var m_pid = "<?php echo $detail['id'] ;?>" ;
    var m_p_type = "<?php echo $detail['p_type'] ;?>" ;
