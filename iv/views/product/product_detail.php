...
<p class="edit_item"><span class="lable1">行程介绍</span><?php if(isset($travel_introduction))echo $travel_introduction; ?></p>
...
function preview() {
	document.oneday.action="/provider/preview";
	document.oneday.submit() ;
}

function commit() {
	document.oneday.action="/provider/commit";
	document.oneday.submit() ;
}
</script>
