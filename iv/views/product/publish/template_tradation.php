...
<div class="col-sm-8 col-sm-push-3" style="margin-top:30px;padding-left:0px">
    <span>添加产品</span>><span>一日游</span>
</div>
<div class="col-sm-8 col-sm-push-3" style="border:solid #cccccc 1px;margin-top:30px">
    
    <form method="post" name="oneday" id="oneday_form" class="form-horizontal y-margin-bottom-10px" action="/index/addproduct">
        ...
        <div class="form-group">
                ...
                <div class="col-lg-4">
                   <div class="radio">
                        <label>
                            <input type="radio" name="lang" value="中文" />  中文服务
                        </label>
                </div>
                <div class="radio">
                    <label>
                        <input type="radio" name="lang" value="英语" /> 英文服务
                    </label>
                </div>
                <div class="radio">
                    <label id="onther">
                        <input type="radio" name="lang" value="other"/> 其他本地语言
                    </label>
                </div>
        ...
        <div class="row col-sm-offset-2  y-margin-top-20px y-margin-bottom-10px">
            ...
            <button type="submit" class="col-sm-2 col-sm-offset-1 btn btn-primary"  id="validateBtn">提交</button>
        </div>
