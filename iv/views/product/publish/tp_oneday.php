...
<style>
   ...
   .destination select~i{
    ...
    .has-success .checkbox, .has-success .checkbox-inline, .has-success .control-label, .has-success .help-block, .has-success.checkbox label, .has-success.checkbox-inline label {
    color: #0097d6;
    }
    .radio label{
         color:#585858;
...
<div class="col-sm-10 col-sm-push-3" style="margin-top:30px;padding-left:0px">
    <span><a href="/publish/product_select">添加产品</a></span> > <span>一日游</span>
</div>
<div class="col-sm-8 col-sm-push-3" style="border:solid #cccccc 1px;margin:30px 0px 40px;padding-left:0px">
    ...
    <form method="post" name="oneday" id="oneday_form" class="form-horizontal y-margin-bottom-10px" action="/publish/add_product">
        ...
        <div class="form-group">
            ...
            <?php
//            $detail['tagname']
                $CI->load->view('product/components/com_tags_mng', null) ;
            ?>
        </div>
        <div class="form-group">
        ...
        <div class="row y-margin-top-10px" style="margin-bottom:20px">
            ...
            <div class="col-sm-10 ueditorone">
        ...
        <div class="form-group min_group">
            
                <label class="col-lg-2 control-label">最低成团人数</label>
               
                <div class="col-sm-5">
                    <input type="text" name="min_num" value="" class="form-control" placeholder="输入最低成团人数" />
                </div>
        </div>
        ...
        <input type="hidden" name="tagname" value="" id="tag_name">
        <input type="hidden" name="p_status" value="" id="p_status">   
        <div class="row col-sm-offset-2  y-margin-top-20px y-margin-bottom-10px subtn">
   ...
   $('#validateBtn').click(function(){
     $('#defaultForm').bootstrapValidator('validate');
      var travel_introduction = UE.getEditor('travel_introduction').getContent();
        ...
        if( 6 <com_img_upload.get_com_img_upload_img_ids().length < 20){
            alert('请上传6-20张图片') ;
            return false;
        }
