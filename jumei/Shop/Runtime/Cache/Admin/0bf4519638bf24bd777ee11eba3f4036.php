        ...
        <div class="col-lg-12">
            <div class="panel panel-yellow">
                ...
                <div class="table table-striped table-bordered table-hover">
                    &nbsp;&nbsp;&nbsp; <a href='/jumei/Admin/Goods/add'><button type="button" class="btn btn-outline btn-danger">添&nbsp;&nbsp;   加</button></a>
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                            <?php if(is_array($goods)): foreach($goods as $k=>$vo): ?><tr class="odd gradeA">
                                    <td><?php echo ($vo["id"]); ?></td>
                                    <td><?php echo ($vo["gname"]); ?></td>
                                    <td><img src="<?php echo ($vo["spic"]); ?>" alt="" width="100px"></td>
                                    <?php $a=count($vo['cateinfo']); ?>
                                    <td>
                                        <?php $__FOR_START_18125__=0;$__FOR_END_18125__=$a;for($i=$__FOR_START_18125__;$i < $__FOR_END_18125__;$i+=1){ echo ($vo['cateinfo'][$i]['name']); } ?>
                                    </td>
                                    <td><?php echo ($vo['bname'][$i]['bname']); ?></td>
                                    ...
                                    <td>
                                        <a href="<?php echo U('Admin/Goods/edit', array('id'=>$vo['id']));?>"><button type="button" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></button></a>

                                        <a href="<?php echo U('Admin/Goods/delete', array('id'=>$vo['id']));?>"><button type="button" class="btn btn-info btn-circle"><i class="fa fa-times"></i></button></a>
                                    </td>                              
