...
<body>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">活动进行中的品牌</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-yellow">
                ...
                <div class="table table-striped table-bordered table-hover">
                    &nbsp;&nbsp;&nbsp; <a href='/jumei/Admin/Activity/add'><button type="button" class="btn btn-outline btn-danger">添&nbsp;&nbsp;   加</button></a>
                </div>
                <!-- /.panel-heading -->
                    ...
                    <div class="dataTable_wrapper">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th style="width:60px;">品牌名称</th>
                                    <th style="width:60px;">所属分类</th>
                                    <th style="width:240px;">图片路径</th>
                                    <th>满</th>
                                    <th>减</th>
                                    <th>活动开始日期</th>
                                    <th>活动开始时间</th>
                         ...
                         <?php if(is_array($res)): foreach($res as $key=>$vo): ?><tr class="gradeA odd" role="row">
                                ...
                                <td class="username"><?php echo ($vo['pname']); ?></td>
                                <td><?php echo ((isset($vo['bid']) && ($vo['bid'] !== ""))?($vo['bid']):'顶级分类'); ?></td>
                                <td class="center"><?php echo ($vo['img']); ?></td>
                                <td class="center"><?php echo ($vo['full']); ?></td>
                                <td class="center"><?php echo ($vo['subtract']); ?></td>
                                <td class="center"><?php echo ($vo['sdate_submit']); ?></td>
                                <td class="center"><?php echo ($vo['stime']); ?></td>
                                <td class="center"><?php echo ($vo['edate_submit']); ?></td>
                                <td class="center"><?php echo ($vo['etime']); ?></td>
                                <td class="center"><?php echo ($vo['power']); ?></td>
                                <td class="center">
                                    <a href="<?php echo U('Admin/Activity/edit', array('pid'=>$vo['pid']));?>" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>&nbsp;
                                    <a href="<?php echo U('Admin/Activity/delete', array('pid'=>$vo['pid']));?>" class="btn btn-info btn-circle"><i class="fa fa-times"></i></a>
                                </td>
