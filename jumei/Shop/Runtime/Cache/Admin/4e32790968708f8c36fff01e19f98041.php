        ...
        <div class="col-lg-12">
            <div class="panel panel-yellow">
                ...
                <div class="table table-striped table-bordered table-hover">
                    &nbsp;&nbsp;&nbsp; <a href='/jumei/Admin/User/add'><button type="button" class="btn btn-outline btn-danger">添&nbsp;&nbsp;   加</button></a>
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                            <?php if(is_array($users)): foreach($users as $k=>$vo): ?><tr class="odd gradeA">
                                    <td><?php echo ($vo["id"]); ?></td>
                                    <td><?php echo ($vo["realname"]); ?></td>
                                    <td><img src="<?php echo ($vo["pic"]); ?>" width="80px"></td>
                                    <td><?php echo ($vo["groups"]); ?></td>
                                    <td>
                                        <a href="<?php echo U('Admin/User/edit', array('id'=>$vo['id']));?>"><button type="button" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></button></a>

                                        <a href="<?php echo U('Admin/User/delete', array('id'=>$vo['id']));?>"><button type="button" class="btn btn-info btn-circle"><i class="fa fa-times"></i></button></a>
                                    </td>                              
