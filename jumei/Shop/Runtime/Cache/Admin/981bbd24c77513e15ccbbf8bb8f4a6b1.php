...
<body>
    ...
    <div class="row" >
        <div class="col-lg-12" >
            <div class="panel panel-default" style="background: rgba(0, 0, 0, 0) url('/jumei/Public/Admin/imgs/background.jpg') no-repeat scroll center top;">
                        ...
                        <div class="col-lg-6">
                            ...
                            <form role="form" action="<?php echo U('Admin/User/insert');?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>真实姓名</label>
                                    <input name="realname" type="text" class="form-control" placeholder="请输入2位中文字符以上">
                                </div>
                                <div class="form-group">
                                    <label>密码</label>
                                    <input name="password" type="password" class="form-control" placeholder="请输入8~16非空白字符">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" name="sex" id="optionsRadiosInline1" value="0" checked="">女
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="sex" id="optionsRadiosInline2" value="1">男
                                    </label>
                                </div>
                                <div class="form-group">
                                    <label>用户组</label>
