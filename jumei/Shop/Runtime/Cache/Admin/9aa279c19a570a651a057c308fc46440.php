        ...
        <div class="col-lg-12">
            <div class="panel panel-yellow">
                ...
                <div class="table table-striped table-bordered table-hover">
                    &nbsp;&nbsp;&nbsp; <a href='/jumei/Admin/Admin/add'><button type="button" class="btn btn-outline btn-danger">添&nbsp;&nbsp;   加</button></a>
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                            <?php if(is_array($admins)): foreach($admins as $k=>$vo): ?><tr class="odd gradeA">
                                    <td><?php echo ($vo["uid"]); ?></td>
                                    <td><?php echo ($vo["username"]); ?></td>
                                    <td><?php echo ($vo["email"]); ?></td>
                                    <td>
                                    <?php $a=intval($vo['group_id']); switch($a){ case 1: echo '管理员'; break; case 2: echo '编辑'; break; default: echo '游客'; break; } ?>
                                    
                                    </td>
                                    <td>
                                        <a href="<?php echo U('Admin/Admin/edit', array('id'=>$vo['uid']));?>"><button type="button" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></button></a>

                                        <a href="<?php echo U('Admin/Admin/delete', array('uid'=>$vo['uid']));?>"><button type="button" class="btn btn-info btn-circle"><i class="fa fa-times"></i></button></a>
                                    </td>                              
