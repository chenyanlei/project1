        ...
        <div class="col-lg-12">
            <div class="panel panel-yellow">
                ...
                <div class="table table-striped table-bordered table-hover">
                    &nbsp;&nbsp;&nbsp; <a href='/jumei/Admin/Cate/add'><button type="button" class="btn btn-outline btn-danger">添&nbsp;&nbsp;   加</button></a>
                </div>
                <!-- /.panel-heading -->
                    ...
                    <div class="dataTable_wrapper">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                         ...
                         <?php if(is_array($cates)): foreach($cates as $key=>$vo): ?><tr class="gradeA odd" role="row">
                                ...
                                <td class="username"><?php echo ($vo['name']); ?></td>
                                <td><?php echo ((isset($vo['names']) && ($vo['names'] !== ""))?($vo['names']):'顶级分类'); ?></td>
                                <td class="center"><?php echo ($vo['path']); ?></td>
                                <td class="center">
                                    <a href="<?php echo U('Admin/Cate/edit', array('id'=>$vo['id']));?>" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>&nbsp;
                                    <a href="<?php echo U('Admin/Cate/delete', array('id'=>$vo['id']));?>" class="btn btn-info btn-circle"><i class="fa fa-times"></i></a>
                                </td>
